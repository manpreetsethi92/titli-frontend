        ...
        <div className="relative">
          ...
          {showSuccess ? (
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">Choose your preferred platform:</p>
              
              <div className="flex flex-col gap-3">
                {/* Telegram Button */}
                <button 
                  onClick={() => handleStartTexting('telegram')} 
                  className="w-full h-14 rounded-full text-white font-semibold text-lg flex items-center justify-center gap-3 transition-all hover:opacity-90" 
