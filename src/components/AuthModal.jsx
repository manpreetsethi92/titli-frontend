            ...
            <div className="p-8">
                ...
                <div>
                  ...
                  <form onSubmit={handleSendOTP}>
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-gray-400 mt-1">US numbers: just enter 10 digits. International: include country code</p>
                    </div>
              ...
              {step === "otp" && (
                <div>
                  ...
                  <p className="text-gray-500 text-sm mb-4">Enter the code sent to {formatPhoneNumber(phone)}</p>
